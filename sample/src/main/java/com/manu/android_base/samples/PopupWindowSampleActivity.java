...
import static com.manu.baselibrary.widget.MPopupWindow.LocationType.BOTTOM_CENTER;
...
import static com.manu.baselibrary.widget.MPopupWindow.LocationType.RIGHT_BOTTOM;
import static com.manu.baselibrary.widget.MPopupWindow.LocationType.RIGHT_CENTER;
import static com.manu.baselibrary.widget.MPopupWindow.LocationType.RIGHT_TOP;
import static com.manu.baselibrary.widget.MPopupWindow.LocationType.TOP_CENTER;
import static com.manu.baselibrary.widget.MPopupWindow.LocationType.TOP_LEFT;
import static com.manu.baselibrary.widget.MPopupWindow.LocationType.TOP_RIGHT;
    ...
    private void showOriginPopupWindow() {
        contentView.findViewById(R.id.tvCamera).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(PopupWindowSampleActivity.this, "相机", Toast.LENGTH_SHORT).show();
            }
        });
        contentView.findViewById(R.id.tvPhoto).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(PopupWindowSampleActivity.this, "相册", Toast.LENGTH_SHORT).show();
            }
        });
