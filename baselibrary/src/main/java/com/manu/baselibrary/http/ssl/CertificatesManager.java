...
public class CertificatesManager {
    ...
    public CertificatesManager(InputStream... certificates) {
        this.certificates = certificates;
    }

    public CertificatesManager(List<InputStream> certificates) {
        this.certificates = certificates.toArray(new InputStream[]{});
    }

    public void setBksFileAndPassword(InputStream bksFile, String password) {
    ...
    public void setCertificates(OkHttpClient.Builder builder) {
        try {
            ...
            builder.hostnameVerifier(new SkirtHttpsHostnameVerifier());
